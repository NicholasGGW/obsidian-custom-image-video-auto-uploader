...
export default <LangMap>{
  ...
  "视频上传 API 地址": "Video upload API address",
  "用于上传视频的独立 API 地址（留空则使用上方图片 API 地址）。Custom Image Gateway 目前仅支持图片，若需上传视频请配置支持视频直传的端点": "Separate API endpoint for video uploads (leave empty to use the image API above). Custom Image Gateway only supports images; configure a video-capable endpoint here if needed",
